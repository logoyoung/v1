...
<head>
    ...
    <link rel="stylesheet" href="{#hpCSS#}liveroom_v4.css{#hpVersion#}">
    <link rel="stylesheet" href="{#hpCSS#}pushLiveBox.css{#hpVersion#}"/>
...
<div style="position:absolute;width: 100px;left: -1000px;overflow:hidden;bottom:0;">
    <div id="imProxy">
        <object width="100" height="100" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" data="" type="">
        ...
        <div class="liveroom-container" id="liveroom-container">
            ...
            <div class="liveroom-content" id="liveroom-content">
                ...
                <div class="liveroom_opt">
                    ...
                    <div class="gift_box">
                        <ul class="gift" id="gift-container">
