...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet box bg-yellow-gold" id="anchorRecommend">
                        <div class="portlet-title">
                            <div class="caption">
                                <h4 class="page-title">首页直播推荐</h4>
                            </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body inner">
                            ...
                            <div class="tabbable">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="news" data-toggle="tab" aria-expanded="true" @click="changeView(0)">已推荐主播</a></li>
                                    <li class=""><a href="events" data-toggle="tab" aria-expanded="true" @click="changeView(1)">待推荐主播</a></li>
                                    <div class="option-bar pull-right">
                                        <a class="btn" @click="create">新建</a>
                                    </div>
                                </ul>
                                <div class="tab-content no-space" >
                                    <recommend :keyword="keyword" :go-search.sync="goSearch" :element-id="'recommend'" :view-page="viewPage" :is-show.sync="isShow"></recommend>
                                </div>
                            </div>
        ...
        <script type="text/javascript" src="../common/admin/pages/scripts/liveRecommend.js"></script>
