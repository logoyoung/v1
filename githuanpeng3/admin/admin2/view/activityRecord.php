            ...
            <div class="page-content-wrapper">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box bg-yellow-gold"> 
                                <div class="portlet-title">
                                    <div class="caption">
                                        <h4 class="page-title">活动&内部发放记录</h4>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover line-height">
                                        <thead>
                                            <tr>
                                                <th width="10%">日期</th>
                                                <th width="10%">活动下发欢朋币总数</th>
                                                <th width="10%">活动下发欢朋豆总数</th>
                                             <th width="10%">操作</th>
                                            </tr>
                                        </thead>
                ...
                <script type="text/javascript">
                    $(document).ready(function () {
                        getAncitivyRecordList();
                    });
                    function getAncitivyRecordList() {
                        var domUlStr = '';
                        var domLiStr = '';
                        $("#typebodys tr").remove();
                        $.ajax({
                    ...
                    function jump(month){
                      ...
                      location.href=encodeURI($conf.domain + "view/activityRecordInfo.php?m="+m);
                    }
