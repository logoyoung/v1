...
class AdminHelp
{
    ...
    static function delLoginCookie()
    {
        setcookie('admin_uid', '', time() - 24*3600, '/admin2', '.huanpeng.com');
        setcookie('admin_enc', '', time() - 24*3600, '/admin2', '.huanpeng.com');
        setcookie('admin_type', '', time() - 24*3600, '/admin2', '.huanpeng.com');
        setcookie('admin_name', '', time() - 24*3600, '/admin2', '.huanpeng.com');
    }
