...
class Event
{
    ...
    public static $emptyUidAction  = [
        EventManager::ACTION_GITF_UPDATE,
        EventManager::ACTION_ROOM_PROMOTION_UPDATE,
    ];
    ...
    public function push()
    {
        ...
        if(!$this->_param['uid'] && !in_array($this->_ac,self::$emptyUidAction))
        {
        ...
        if(!in_array($this->_ac,self::$emptyUidAction))
        {
