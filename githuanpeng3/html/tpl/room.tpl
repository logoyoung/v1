...
<head>
    ...
    <script type="text/javascript">
      ...
      if (navigator.userAgent.toLowerCase().match(/(iphone|ipod|android|ios|ipad|ucweb)/i)){ location.href = $conf.domain+'h5share/live.php?u='+$ROOM.anchorUserID; }
    </script>
...
<div style="position:absolute;width:0;overflow:hidden;bottom:0;">
    <div id="imProxy">
