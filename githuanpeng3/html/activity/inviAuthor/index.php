...
<div class="mDownload">
    <img src="closeBtn.png" class="close">
    <figure>
        <img src="hpLogo.jpg">
        <figcaption>
            <p style="margin-bottom:.4rem;  ">下载App领取欢朋豆</p>
...
<script>
    ...
    (function () {
        if (navigator.userAgent.toLowerCase().match(/(iphone|ipod|android|ios|ipad|ucweb|micromessenger)/i))  {
            ...
            var  mDownload= document.querySelector('.mDownload');
