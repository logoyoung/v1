...
(function(){
    ...
    if( document.domain == 'www.huanpeng.com'){
        env = 'pro';
        _domain = _protocol + 'www.huanpeng.com/';
        cookiepath = '/';
    }
...
function getShareContent(channel,liveTitle,anchorNick,luid,suid,isWxShare){
    ...
    var url = $conf.domain+'mobile/room/room.html?luid='+luid
    if(isWxShare){
        url = $conf.domain + 'mobile/room/room.html?luid='+luid;
    }
...
(function () {
    ...
    Share = {
        ...
        wx_qrcode: function (top, left) {
            ...
            a('#wx_qrcode').qrcode({
                render: 'table',
                text: $conf.domanin + 'mobile/room/room.html?luid='+$ROOM.anchorUserID
            });
