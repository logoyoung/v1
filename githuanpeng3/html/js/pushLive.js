        ...
        function initNotice(){
            if(!dialog.get(loadID)){
                ...
                $(node).find('.loading-gif').css({
                    'min-width': '20px',
                    height: '20px',
                    'background-image': 'url("http://dev.huanpeng.com/main/static/img/gif/load.gif")',
