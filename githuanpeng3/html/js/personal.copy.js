...
(function(){
    ...
    ajaxRequest({url:requestUrl,data:requestData},function(d){
        ...
        personalInfo.find('.personalInfo .bar .levelbar').width(levelbar_width + 'px');
            ...
            function editStatus() {
                ...
                function return_notice_word() {
                    ...
                    if(modifyNickFree == '1'){
                        ...
                        return "<p class='ui-state-error-text left'>欢朋币不足请充值<a class='right modifyNick-recharge' href='" + $conf.person + "recharge.php'>充值</a></p>";
                    } else {
