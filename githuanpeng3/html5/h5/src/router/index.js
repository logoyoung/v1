...
const Search = (resolve) => {
  import('page/search/search').then((module)=> {
    resolve(module)
  })
}
const SearchMore = (resolve) => {
  import('page/search/search-more').then((module)=> {
    resolve(module)
  })
}
...
export default new Router({
  ...
  routes: [
    ...
    },
    {
      path: '/search',
      name: 'search',
      components: { keepAliveRouter: Search},
      children: [{path:'searching',redirect: '/search'}]
    },
    {
      path: '/searchmore',
      name: 'searchmore',
