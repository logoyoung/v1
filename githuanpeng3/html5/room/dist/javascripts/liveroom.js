...
$(function () {
    ...
    var SEND_WATCH_TIMER = (Math.floor(Math.random() * 21) + 20) * 1000; //20-40秒 发送 时长
    var COMMAND_MAP = {
        'result': 'sendCallback',
    ...
    var giftAndPack = function giftAndPack() {
    ...
    var LiveRoom = {
        ...
        _initBindPackEvent: function _initBindPackEvent() {

            var packEvent = function packEvent(responseData) {
                var htmlArr = [];
        ...
        _initWatchTimeCalc: function _initWatchTimeCalc(flag) {

            var sendWatchLiveTime = function sendWatchLiveTime() {
