...
if(!defined("HP_SMARTY_CACHE_DIR"))
{
	define("HP_SMARTY_CACHE_DIR",'/data/huanpeng-cache/smarty/');
}
...
class Smarty extends Smarty_Internal_TemplateBase
{
     ...
     * @var array
     */
    protected $template_dir = array(__DIR__.'/../../tpl/');
     ...
     * @var array
     */
    protected $config_dir = array(__DIR__.'/../../tpl/config/');
     ...
     * @var string
     */
    protected $compile_dir = HP_SMARTY_CACHE_DIR."template_c/";//__DIR__.'/../../tpl/template_c/';
     ...
     * @var string
     */
    protected $cache_dir = HP_SMARTY_CACHE_DIR."cache/";//__DIR__.'/../../tpl/cache/';
