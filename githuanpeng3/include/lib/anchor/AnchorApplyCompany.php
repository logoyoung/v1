...
class AnchorApplyCompany
{
    ...
    public static $fields = [
        ...
        'gamelevel',// varchar(255) DEFAULT NULL COMMENT '游戏等级',
        'qq',//bigint(16) unsigned DEFAULT NULL COMMENT 'qq号',
        'showface',// tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否露脸直播',
    ];
    /**
 * 定义表名 主播签约经纪公司表
 * @return string
 */
    ...
    public function addAnchorApplyCompany($data)
    {
        ...
        $sql = "INSERT INTO `{$this->tableName()}` (`uid`,`cid`,`videoid`,`gameid`,`gamelevel`,`qq`,`showface`) VALUES(:uid,:cid,:videoid,:gameid,:gamelevel,:qq,:showface)";
