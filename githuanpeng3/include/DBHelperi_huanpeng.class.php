...
require_once( INCLUDE_DIR . 'DBHelperi.class.php' );

class DBHelperi_huanpeng extends DBHelperi
{
	public $env = '';
...
//            'w' => 'mysql://hpdev:hhppddeevv112233@172.20.0.231:3306/huanpeng_dev',
			'w' => 'mysql://hpdev:hhppddeevv112233@192.168.21.64:3306/huanpeng',
			'r' => 'mysql://hpdev:hhppddeevv112233@192.168.21.64:3306/huanpeng',
		),
		"PRE" => array(
			'w' => 'mysql://hpdev:hhppddeevv112233@192.168.21.65:3306/huanpeng',
			'r' => 'mysql://hpdev:hhppddeevv112233@192.168.21.65:3306/huanpeng',
		),
		'PRO' => array(
//			'r' => 'mysql://hppro:huanpro123peng@172.20.0.221:3306/huanpeng',
//			'w' => 'mysql://hppro:huanpro123peng@172.20.0.231:3306/huanpeng',
	...
	protected function _prepareConnection( $type = DBHELPERI_DBALL )
	{
		...
		{
			$this->_dbr_url = $this->dbconf[$this->env]['r'];
		}
		if( $type & DBHELPERI_DBW )
		{
			$this->_dbw_url = $this->dbconf[$this->env]['w'];
		}
	...
	public function insertDuplicate( $tbName, $data, $update, $deBugSql = '' )
	{
		$data = $this->_dataFormat( $tbName, $data );
		if( !$data )
		{
		...
		$sql_1 = "insert into " . $tbName . "(" . implode( ',', array_keys( $data ) ) . ") values(" . implode( ',', array_values( $data ) ) . ")";

		$update = $this->_dataFormat( $tbName, $update );
		if( !$data )
		{
			return;
		}
		...
		{
			array_push( $valArr, $k . "=" . $v );
		}
		$valStr = implode( ',', $valArr );

		$sql_2 = " on duplicate key update " . trim( $valStr );
