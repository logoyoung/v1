...
<head>
    ...
    <link rel="stylesheet" href="css/myExchange.css">
    ...
    <script src="js/myExchange.js?t=<?php echo time(); ?>" type="text/javascript"></script>
</head>
<body>
    ...
    <div class="myExchange-container">
        ...
        <div class="myExchange-surplus">
            ...
            <p class="surplus-hp">
                ...
                欢朋币余额: <span class="hpMoney">0</span>
        ...
        <div class="myExchange-select">
            ...
            <ul class="select-bottom">
                ...
                <li>
                    <p class="hp">1,000欢朋币</p>
                    <p class="gold">100金币</p>
                </li>
                <li>
                    <p class="hp">2,000欢朋币</p>
                    <p class="gold">200金币</p>
                </li>
                <li>
                    <p class="hp">5,000欢朋币</p>
                    <p class="gold">500金币</p>
                </li>
