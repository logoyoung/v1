...
class setSilenced
{
    ...
    const ERROR_TUID_IS_MANAGER = -8525;
    ...
    public static $erroMsg = [
        ...
        self::ERROR_TUID_IS_MANAGER => '不能禁言房管',
    ];
    ...
    public function display()
    {
        ...
        //房管uid
        $this->_roomManagerService->setManagerUid($this->_uid);
        //禁方用户uid
        ...
        //判断被禁者是否为房管
        if($this->_roomManagerService->setManagerUid($this->_targetUid)->isRoomManager())
        {
            $code = ERROR_TUID_IS_MANAGER;
            $msg  = self::$erroMsg[$code];
            render_error_json($msg,$code,2);
        }
