...
//比率|内部发放密钥
define( "RATE_SECRET", '7xcayBT&Mzm*BbW4fS44zidC9tI$DMkt' );
define( "INNER_SECRET", 'Kbx!vXI2Q^I45E!*Rms@FDaD$Tnbmbih' );
...
//
if(isset($_SERVER['HTTP_HOST']) && $_SERVER['HTTP_HOST'] == "www.huanpeng.com" && $GLOBALS['env'] != "PRO")
{
...
//		$GLOBALS['env'] = "DEV";
//	}
//	elseif( $_SERVER["HTTP_HOST"] == DOMAINNAME_PRE )
//	{
//		$GLOBALS['env'] = "PRE";
//	}
//	else
...
//if( isset( $_SERVER['HTTP_HOST'] ) )
//{
//	if( $_SERVER['HTTP_HOST'] == '122.70.146.49:9091' || $_SERVER['HTTP_HOST'] == "122.70.146.49" || $_SERVER['HTTP_HOST'] == 'dev-pay.huanpeng.com')
//	{
//		$GLOBALS['env'] = "DEV";
//	}
//	elseif( $_SERVER['HTTP_HOST'] == '122.70.146.50:9091' || $_SERVER['HTTP_HOST'] == "122.70.146.50" || $_SERVER['HTTP_HOST'] == "pre-pay.huanpeng.com" )
//	{
//		$GLOBALS['env'] = "PRE";
//	}
//}
...
define( "WEB_ROOT_URL", DOMAIN_PROTOCOL . constant( "DOMAINNAME_" . strtoupper( $GLOBALS['env'] ) ) . "/" );
...
define("DEFAULT_SYSTEM_PIC", STATIC_IMG_PATH."due/systemIcon.png");
define( "VERTICAL", STATIC_IMG_PATH . '/vertical_screen.jpg' ); //竖屏默认图
define( "CROSS", STATIC_IMG_PATH . '/src/default/260x150.png' ); //横屏默认图
//直播教程相关
define( "OFFICIALVIDEO_CLIENT", $GLOBALS['env-def']['PRO']['huan-video'] . '/officialVideo/hclient.mp4' );
define( "OFFICIALVIDEO_IOS", $GLOBALS['env-def']['PRO']['huan-video'] . '/officialVideo/HIOS.mov' );
define( "OFFICIALVIDEO_ANDROID", $GLOBALS['env-def']['PRO']['huan-video'] . '/officialVideo/Android.mp4' );
