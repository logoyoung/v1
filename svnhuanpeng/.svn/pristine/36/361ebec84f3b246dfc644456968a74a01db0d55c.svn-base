    ...
    <div class="nav-box fast-click" v-show="navShow" @touchstart="slideStart" @touchend="slideEnd" @touchmove.prevent>
      <div class="wrapper">
        <section class="nav-user blur-container" v-show="uid">
          <div class="blur-bg" :style="setBackgroundImg"></div>
          <div class="nav-user-photo">
            <img class="user-photo" v-lazy="userDetail.head">
            <!-- <img class="user-photo" src="/static/images/logo.png" alt="" @load="alert(1)"> -->
          </div>
        ...
        <section class="nav-user blur-container" v-show="!uid">
          <div class="blur-bg" :style="setBackgroundImg"></div>
          <div class="nav-user-photo">
            <img class="user-photo" :src="userDetail.head">
...
export default {
  ...
  computed: {
    setBackgroundImg() {
      return {
        'background-image': 'url(' + this.userDetail.head + ')'
      }
    },
    ...mapGetters([
      'uid',
  ...
  methods: {
    ...
    logout() {
      ...
      deleteCookie('_uid');
      deleteCookie('_enc');
      this.userDetail = { head: 'http://www.huanpeng.com/static/img/userface.png' };
