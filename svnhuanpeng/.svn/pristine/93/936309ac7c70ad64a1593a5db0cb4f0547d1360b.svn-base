        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                            ...
                            <div class="portlet box bg-yellow-gold"> 
                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover line-height">
                                        <thead>
                                            <tr>
                                                <th width="10%">主播UID</th>
                                                <th width="10%">昵称</th>
                                                <th width="10%">所属公司</th>
                                                <th width="10%">可兑换金豆数</th>
                                                <th width="10%">可兑换金币数</th>
                                                <th width="10%">兑换比例</th>
                                                <th width="10%">兑换总额</th>
                                            </tr>
                                        </thead>
                ...
                <script type="text/javascript">
                    ...
                    function getAnchorExchange() {
                        $("#typebodys tr").remove();
                        $.ajax({
                            url: '../api/statistic/anchorExchange.php',
                            dataType: 'json',
                            data:{
