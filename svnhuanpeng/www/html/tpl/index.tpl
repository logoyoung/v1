...
<div class="content trans of">
    ...
    {/if}
        <div class="game-title of">
            ...
            <div class="gamebtnBox l">
                <a href="javascript:;" class="game-new cur">最新</a>
                <a href="javascript:;" class="game-hot">最热</a>
            ...
            <div class="gamer-btnbox r">
                <span class="gamer-l">共<span
                            class="fc-orange">{$content.content.homePageGameList.wzry.new.total}</span>场直播</span>
                <a href="./GameZone.php?gid=190" target="_blank" class="gamer-r">更多>> </a>
            </div>
        </div>
        <div class="gamer-live of">
            <ul class="gameBox-ul trans" game-tab="new">
            ...
            <ul class="gameBox-ul trans" game-tab="hot" style="display: none;">
    ...
    {if $content.content.homePageGameList.qqdzz.new.total == 0}
      <div class="game-block" style="display:none;">
      {else}
      <div class="game-block">
    {/if}
        <div class="game-title of">
            ...
            <div class="gamer-btnbox r">
                <span class="gamer-l">共<span
                            class="fc-orange">{$content.content.homePageGameList.qqdzz.new.total}</span>场直播</span>
    ...
    {if $content.content.homePageGameList.cyhx.new.total == 0}
      <div class="game-block" style="display:none;">
      {else}
      <div class="game-block">
    {/if}
        <div class="game-title of">
            ...
            <div class="gamer-btnbox r">
                <span class="gamer-l">共<span
                            class="fc-orange">{$content.content.homePageGameList.cyhx.new.total}</span>场直播</span>
