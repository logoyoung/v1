...
/*投票活动*/
CREATE TABLE IF NOT EXISTS `due_vote_activity` (
 ...
 /*英雄投票表*/
CREATE TABLE IF NOT EXISTS `due_vote_nums` (
 ...
 /*投票日志表*/
CREATE TABLE IF NOT EXISTS `due_vote_log` (
 ...
 /*报名表*/
CREATE TABLE IF NOT EXISTS `due_enroll`(
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
