...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet box bg-yellow-gold" id="unpublishBody">
                        <div class="portlet-title">
                            <div class="caption">
                                <h4 class="page-title">待发布</h4>
                            </div>
                            <div class="tools">
                                <form class="navbar-form pull-right" onsubmit="return false;">
                                    <input type="text" class="form-control" id='keyword' placeholder="" v-model="keyword"/>
                                    <button type="button" class="btn bg-yellow-gold" id='search' @click="search">搜索</button>&nbsp;&nbsp;&nbsp;
                                </form>
                            </div>
                        </div>
                        <div class="portlet-body inner">
                            <div class="tabbable">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="news" data-toggle="tab" aria-expanded="true" @click="changeView(0)">新闻</a></li>
                                    <li class=""><a href="events" data-toggle="tab" aria-expanded="true" @click="changeView(1)">活动</a></li>
                                    <li class=""><a href="announcement" data-toggle="tab" aria-expanded="true" @click="changeView(2)">公告</a></li>
                                ...
                                <div class="tab-content no-space" >
                                    <news :keyword="keyword" :go-search.sync="goSearch" :element-id="'unpub'" :tid="tid"></news>
                                </div>
                            </div>
        ...
        <script type="text/javascript" src="../common/admin/pages/scripts/newsUnpublish.js"></script>
