                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green-meadow"> 
                                <div class="portlet-title">
                                    <div class="caption">
                                        <h4 class="page-title">首页游戏列表</h4>
                                    </div>
                                    <div class="tools">
                                        <button type="button" class="btn btn-success" id="addGameType">+新增推荐</button>
                                    </div>
                                </div>
                                    ...
                                    <div class="portlet-body form">
                                        ...
                                        <form id="upicon" name="upicon" action="../api/tool/upLoadPic.php" method="post" enctype="multipart/form-data" class="form-horizontal form-row-seperated">
                                            <div class="form-body">
                                                ...
                                                <label class="control-label col-md-3">选择游戏 <span class="required">
                                                        * </span>
                                                </label>
                                                <div class="col-md-4">
                ...
                <div class="modal" id="upmodal">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" id="up_new_form" class="btn btn-primary">保存</button>
                                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                                ...
                                if (data) {
                                    $.each(data.data, function (i, item) {
                                        $("#typebodys").append(
                                                ...
                                                + '<td><button class="btn btn-info btn-sm " onclick="gameTypeUpdate(this)">修改</button><button class="btn btn-info btn-sm "  onclick="gameTypeDelete(this)" >删除</button></td>'
                                                + "<tr>"
                                                );
                                    });
                                }
