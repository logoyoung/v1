...
(function(){
    ...
    loginFast = {
        ...
        set_pos:function(){//设置位置
            ...
            // var height = f.height() + parseInt(f.css('padding-top')) + parseInt(f.css('padding-bottom'));

            // f.css('margin-top', -height/2 +'px');
                ...
                if(!val){
                    ...
                    if(id == 'username'){
                        ...
                        if(val.length>=6 && val.length<=12){
                            ...
                            $('#login-error-text-usernick').text('昵称长度6-12位');
                        }
            ...
            loginForm.find('.input-item-text').blur(function(){
                ...
                if(!val){
                    ...
                    if(id == 'username'){
                        ...
                        ajaxRequest({url:requestUrl,data:requestData},function (d) {
                            if(d.isUsed == 1){
                                //todo error mobile code is used
                            }
                            if(getCookie('_login_identCode_open') == 1){
                                initIdentCode();
                            }else{
