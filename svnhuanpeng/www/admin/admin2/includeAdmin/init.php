...
define('INCLUDE_PATH', ADMIN_PATH . '/admin2/includeAdmin/');
define('LIB_PATH', ADMIN_PATH . '/lib/');
define('SYSTEM_PATH', ADMIN_PATH . '/system/');
define('DB_PATH', INCLUDE_PATH . 'DB/');

define('INCLUDE_DIR', ADMIN_PATH . '/admin2/includeAdmin/');
...
define("DOMAINNAME_ADMIN_PRE_IMG", 'admin-pre-img.huanpeng.com');
define('DOMAINNAME_PRO', 'admin.huanpeng.com');
...
require(INCLUDE_PATH . "commonFunction.php");
require(INCLUDE_PATH . "function.php");
require(INCLUDE_PATH . "DBHelps_admin.class.php");
//直播状态 100 正在直播
define('LIVE', 100);
...
//        'domain-vposter'=>DOMAIN_PROTOCOL.'dev-img.huanpeng.com/v',
    ...
    'PRE' => array(
        ...
        'domain-avatar' => DOMAINNAME_ADMIN_PRE_IMG,
        'huan-video' => DOMAIN_PROTOCOL.'img.huanpeng.com/v',
        'domain-video' => DOMAIN_PROTOCOL.'fvod.huanpeng.com',
        'domain-vposter'=>DOMAIN_PROTOCOL.'fvod.huanpeng.com',
        'img-dir' => '/data/huanpeng-img',
...
//用户相关
define("DEFAULT_PIC", 'http://' . $GLOBALS['env-def'][$GLOBALS['env']]['domain'] . '/admin2/common/global/img/userface.png'); //默认头像
define("VERTICAL", 'http://' . $GLOBALS['env-def'][$GLOBALS['env']]['domain'] . '/admin2/static/img/vertical_screen.jpg'); //竖屏默认图
define("CROSS", 'http://' . $GLOBALS['env-def'][$GLOBALS['env']]['domain'] . '/admin2/static/img/src/default/260x150.png'); //横屏默认图
