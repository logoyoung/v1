...
class DbHelper {
    ...
    public static function getConfig($dbKey) {
        ...
        if (isset(self::$config[$dbKey]['master']['options']['timeout'])) {
            self::$config[$dbKey]['master']['options'][PDO::ATTR_TIMEOUT] = (int) self::$config[$dbKey]['master']['options']['timeout'];
            unset(self::$config[$dbKey]['master']['options']['timeout']);
        }

        if(isset(self::$config[$dbKey]['slave']['options']['timeout'])) {
            self::$config[$dbKey]['slave']['options'][PDO::ATTR_TIMEOUT] = (int) self::$config[$dbKey]['slave']['options']['timeout'];
            unset(self::$config[$dbKey]['slave']['options']['timeout']);
        }
